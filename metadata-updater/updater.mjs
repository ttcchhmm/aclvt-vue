...
async function fetchUserList(username) {
    ...
    while (hasMore) {
        ...
        const response = await fetch(`https://api.myanimelist.net/v2/users/${username}/animelist?limit=100&fields=list_status,alternative_titles,media_type,status,synopsis,start_date,end_date,num_episodes,start_season,studios,rating&offset=${offset}&nsfw=true`, {
            headers: {
